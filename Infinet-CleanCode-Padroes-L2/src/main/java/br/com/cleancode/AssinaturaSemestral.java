...
public class AssinaturaSemestral implements AssinaturaInterface {
    ...
    public AssinaturaSemestral(BigDecimal mensalidade, LocalDateTime inicio) {
    ...
    public AssinaturaSemestral(BigDecimal mensalidade, LocalDateTime begin, LocalDateTime fim) {
        this.mensalidade = mensalidade;
        this.inicio = begin;
    ...
    public BigDecimal taxa() {
        LocalDateTime dataAtual = LocalDateTime.now();
            ...
            taxa = mensalidade.multiply(BigDecimal.valueOf(mesesAtivos)).multiply(BigDecimal.valueOf(0.03));
            System.out.println("Taxa a ser cobrada da assinatura semestral: " + getTaxa());
        return taxa;
    }
