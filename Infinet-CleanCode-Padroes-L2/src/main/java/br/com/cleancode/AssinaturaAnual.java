...
public class AssinaturaAnual implements AssinaturaInterface {
    ...
    public AssinaturaAnual(BigDecimal mensalidade, LocalDateTime inicio) {
    ...
    public AssinaturaAnual(BigDecimal mensalidade, LocalDateTime begin, LocalDateTime fim) {
        this.mensalidade = mensalidade;
        this.inicio = begin;
    ...
    public BigDecimal taxa() {
        taxa = BigDecimal.valueOf(0.0);
        System.out.println("Taxa a ser cobrada da assinatura anual: " + getTaxa());
        return taxa;
    }
